...
layout(set = 2, binding = 1) uniform sampler2D normalTextureSampler;
layout(set = 2, binding = 2) uniform sampler2D roughnessTextureSampler;
layout(set = 2, binding = 3) uniform sampler2D metalnessTextureSampler;
